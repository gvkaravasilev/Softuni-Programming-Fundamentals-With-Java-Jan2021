package ProgrammingFundamentalsFinalExamPractise.ProgrammingFundamentalsFinalExam01;
...
public class ThePianist {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n; i++) {
            String piecesInput = scan.nextLine();
        ...
        piecesCollection.entrySet().stream()
                .sorted((left, right) ->{
                    ...
                    return result;
                }).forEach(piece -> System.out.printf("%s -> Composer: %s, Key: %s%n",piece.getKey(),piece.getValue().get(0),piece.getValue().get(1)));
